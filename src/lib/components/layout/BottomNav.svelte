...
<!-- Mobile Bottom Nav -->
<nav
    class="fixed bottom-0 left-0 w-full bg-white dark:bg-bg-secondary border-t border-border z-40 min-[769px]:hidden safe-area-bottom shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]"
>
