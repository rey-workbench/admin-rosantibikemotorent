    ...
    >
      ...
      >
        ...
        <div class="text-right">
          ...
          <div class="text-sm text-gray-900 print:text-black">
            <div class="mb-1">
              <span class="text-gray-400 print:text-black font-medium"
                >From:</span
              >
            ...
            <div>
              <span class="text-gray-400 print:text-black font-medium">To:</span
              >
              <span class="font-bold ml-1"
      ...
      <div class="mb-10 print:mb-8">
        <table class="w-full text-left">
          <thead>
            <tr class="border-b-2 border-gray-900 print:border-black">
              <th
        ...
        <div class="flex justify-end">
          <div class="w-full sm:w-64">
            ...
            >
              ...
              >
                {transaction.status === "PENDING" ? "Tagihan" : "Grand Total"}
              </span>
              <span
      ...
      <div class="mt-12 print:mt-10 text-center">
        ...
        >
          Rosantibike Motorent - Professional Bike Rental Service in Bali
        </p>
      </div>
      ...
      {#if transaction.status === "PENDING" && transaction.qrisBase64}
        ...
        >
          ...
          >
            ...
            <span>Silahkan konfirmasi setelah pembayaran berhasil</span>
          </p>
        </div>
      {/if}
    </div>
